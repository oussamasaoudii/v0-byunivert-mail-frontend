...
export default function MailSidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed md:relative w-64 h-full border-r border-sidebar-border bg-sidebar text-sidebar-foreground flex flex-col z-40 transform transition-transform md:translate-x-0 ${
